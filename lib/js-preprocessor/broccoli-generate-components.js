...
GenerateComponents.prototype.build = function() {
  var components = componentsToGenerate(this.baseDir, this.scss);
...
var componentsToGenerate = function(baseDir, scss) {
  ...
  missingComponents.forEach(function(fileName) {
    var defaultFile = fileName.replace(/(.+)--(.+)\.js$/, '$1--default.js');
    var defaultFileExists = existsSync(path.join(baseDir, defaultFile));
